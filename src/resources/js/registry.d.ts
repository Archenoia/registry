...
declare namespace pages {
    class taxonomy_data extends Bootstrap {
        ...
        static downloadTable(metabolites: viewer.metabolite_sources[]): void;
...
declare namespace viewer {
    ...
    class MassSpecVisualizer {
         ...
         */
        renderBinnedTICChart(data: metabolite_sources[], onBinClick?: (metabolites: metabolite_sources[]) => void, windowSizeMin?: number): void;
        dispose(): void;
    }
}
declare namespace viewer {
